...
<!-- SIDEBAR --><input type="hidden" name="page" value="questions">
            ...
            <div class="content-area" >
                            <div class="panel form-style-6" style="min-width: 300px;float: left">
        ...
        <div class="panel form-style-6" style="float:right;min-width: 600px;">   
        ...
        <option value="<%=list.get(i)%>"><%=list.get(i)%></option>
            ...
            %>
                       ...
                       <tr>
                           ...
                           <td colspan="4"><input type="text" name="question" class="text" placeholder="Type Question here" style="width: 420px;" ></td><br>
                       </tr>
                       <tr>
                           <td><label>Question id: </label></td>
                           <td colspan="4"> <input type="text" name="questionid" class="text" placeholder="Type Question no" style="width: 420px;" ></td><br>  
                       ...
                       <tr>
                           ...
                           <td colspan="4"><center><input type="text" name="correct" class="text" placeholder="Correct Answer" style="width: 230px;float:left;" ></center></td>
                       <tr>
                           <td colspan="5">
